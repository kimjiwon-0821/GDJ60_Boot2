                    ...
                    <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="./findPassword" method="post" enctype="multipart/form-data">
                                    <!-- UserName input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="username" name="username" type="text" placeholder="Enter Title..." data-sb-validations="required" />
                                   ...
                                   <!-- Email input-->
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button class="btn btn-success btn-lg" id="submitButton" type="submit">Send Email</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
